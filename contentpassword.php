...
class plgContentContentPassword extends JPlugin
{
	...
	*/
	...
	private function _process(&$text) {
        ...
        $app   = Factory::getApplication(); //20230217 Ralmarax
        $password  = trim($app->getInput()->getString('contentpassword_password')); //20230217 Ralmarax
	...
	private function _getDialog($description, $title, $error = FALSE) {
		...
		$this->tmpl->assign('action', Uri::getInstance()->toString()); //20230217 Ralmarax
